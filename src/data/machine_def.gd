...
## PROVISIONAL prototype data (2026-06-27 "Machine schema provisional"). A machine is a named
## recipe-runner; there is no machine-type enum or capability system (both deferred). Runtime state lives
## in MachineState; this def is a flyweight.
...
## PROVISIONAL routing tag. Empty (default) = recipe-runner, output falls straight down its column.
