...
## PROVISIONAL prototype data (see DECISIONS.md 2026-06-27 "Machine schema provisional").
...
## (see docs/RISKS.md "Stable IDs"). Items are likewise referenced by StringName id.
