...
##
## I am NOT bulldozing them. Deleting the starting base to make a fixture convenient would be the same
...
## fixture built the floor" has several possible causes and the run should not make me guess between them.
