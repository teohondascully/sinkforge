...
func _initialize() -> void:
	...
	# set for anything sharing this process, and `pointer_posed()` exists precisely so that "I posed it and
	# forgot" cannot masquerade as a passing hardware test somewhere else.
