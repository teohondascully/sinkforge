...
const GOLD_PALE_LIFT := UiTheme.GOLD_PALE_LIFT
const GOLD_PALE := UiTheme.GOLD_PALE
const GOLD_DIM_DROP := UiTheme.GOLD_DIM_DROP
...
const SET_W := SettingsPage.SET_W
const SET_HEAD := SettingsPage.SET_HEAD
const SET_FOOT := SettingsPage.SET_FOOT
