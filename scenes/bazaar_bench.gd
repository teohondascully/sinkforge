...
##
## The first of the counter's tabs to become its own file. It earned it by being the loosest: it reads one
## thing from the counter's state, the sim, and the counter asks it one question back, how tall it wants to
## be. Six constants come with it and nobody else was using them.
##
