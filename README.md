...
107 is a count of registered layers, not a coverage figure. And the suite does not measure whether the
...
| `tools/` | the harness runner and its 107 layers, the play-tests, the capture and profiling tools, the machine lock. |
