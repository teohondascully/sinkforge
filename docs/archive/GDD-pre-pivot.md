> **SUPERSEDED 2026-08-25.** This document describes the pre-pivot persistent-world design.
> Kept for provenance: `legacy/` still contains code that implements what this document
> describes, and an agent reading that code needs to be able to find out why. See the new
> `docs/GDD.md` for current design — its header lists this file among what it supersedes.
