...
## THE FOOTING, UNDER EVERY TRUNK COLUMN AND FOR THE WHOLE BAND (D0626, director-reported).
##
...
## HOW MANY DISTINCT CANOPIES THIS WORLD HAD, AND WHY IT WAS ONE (D0627, queue item 53).
##
