...
##
## THE TARGET IS THE RING, NOT A BEARING FROM THE SPAWN (D0495, strangers 76-81): the smelt rung said
## "the black seam right of you", true only where the game starts you -- 79 stood ON the seam with the
